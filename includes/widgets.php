...
class SocialRing_Fanbox_Widget extends WP_Widget {
	function SocialRing_Fanbox_Widget() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'SocialRing_Fanbox_Widget', 'description' => __('Use this widget to add the Facebook fanbox to your sidebar', WP_SOCIAL_RING));

		/* Widget control settings. */
		$control_ops = array('id_base' => 'social_ring_fanbox_widget');

		/* Create the widget. */
		$this->WP_Widget('social_ring_fanbox_widget', __('Social Ring Fanbox Widget', WP_SOCIAL_RING), $widget_ops, $control_ops );
	}
...
function form($instance) {
		...
		?>
		<p><i><?php _e('This widget needs a sidebar of 300 pixels or more to display properly',WP_SOCIAL_RING); ?></i></p>	
		   <p>
			<ul>
				<?php // WIDGET TITLE ?>
				<li>
				...
				<label><?php _e('FB Page URL',WP_SOCIAL_RING); ?></label>
				</li>
				...
				<label><?php _e('Colorscheme',WP_SOCIAL_RING); ?></label>
				</li>
				...
				<label><?php _e('Show Faces',WP_SOCIAL_RING); ?></label>
				</li>
				...
				<label><?php _e('Header',WP_SOCIAL_RING); ?></label>
				</li>
				...
				<label><?php _e('Stream',WP_SOCIAL_RING); ?></label>
				</li>
				...
				<label><?php _e('Show Border',WP_SOCIAL_RING); ?></label>
				</li>
			</ul>
		   </p>
	...
	$options = get_option(WP_SOCIAL_RING.'_fanbox_options');
	?>
